    ...
    <form action="/admin/customer-service" method="post">
        ...
        <div class="flex gap-2 w-full items-center justify-between">
            ...
            <textarea dir="auto" id="resizeable-ta" name="message" style="field-sizing:content;"
                class="min-h-[1lh] max-h-[3lh] resize-none flex-1 rounded p-2 dark:border-gray-100 dark:bg-gray-600 dark:text-gray-100"
                placeholder="{{ __('keys.your-message') }}" maxlength="2500" minlength="1" rows="1">{{ old('message') }}</textarea>
